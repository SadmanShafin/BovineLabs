...
public class AnyaTests
{
    ...
    public void Search_EuclideanCost_OpenGrid()
    {
        ...
        var optimal = math.distance(new double2(0, 0), new double2(9, 5));
