// <copyright file="PositionWiggleClip.cs" company="BovineLabs">
...
namespace BovineLabs.Vibe.Authoring.LocalTransform
{
    ...
    /// <summary>
    /// Adds low-frequency procedural noise to the transform position.
    /// </summary>
    [Serializable]
    public class PositionWiggleClip : PositionClipBase
    {
        [Tooltip("Amplitude of the wiggle noise in the configured transform space.")]
        [SerializeField]
        private SpaceVector3 amplitude = SpaceVector3.Local(Vector3.one * 0.05f);
        ...
        {
            blob.Type = PositionType.Wiggle;
            blob.TransformOnClipActivation = this.amplitude.UseClipActivation;
            blob.Wiggle = new PositionClipBlob.WiggleData
            {
