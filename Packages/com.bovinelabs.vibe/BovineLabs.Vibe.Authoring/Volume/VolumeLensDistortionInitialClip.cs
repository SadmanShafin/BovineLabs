// <copyright file="VolumeLensDistortionInitialClip.cs" company="BovineLabs">
...
namespace BovineLabs.Vibe.Authoring.Volume
{
    ...
    /// <summary>
    /// Clip that restores lens distortion settings to their captured initial values.
    /// </summary>
    [Serializable]
    public class VolumeLensDistortionInitialClip : DOTSClip, ITimelineClipAsset
    {
        /// <inheritdoc/>
        ...
        public override void Bake(Entity clipEntity, BakingContext context)
        {
            ...
            blob.Type = VolumeLensDistortionClipType.Initial;
