// <copyright file="VolumeShadowsMidtonesHighlightsInitialClip.cs" company="BovineLabs">
...
namespace BovineLabs.Vibe.Authoring.Volume
{
    ...
    /// <summary>
    /// Clip that restores shadows/midtones/highlights settings to their captured initial values.
    /// </summary>
    [Serializable]
    public class VolumeShadowsMidtonesHighlightsInitialClip : DOTSClip, ITimelineClipAsset
    {
        /// <inheritdoc/>
        ...
        public override void Bake(Entity clipEntity, BakingContext context)
        {
            ...
            blob.Type = VolumeShadowsMidtonesHighlightsClipType.Initial;
