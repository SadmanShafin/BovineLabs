// <copyright file="VolumeColorAdjustmentsInitialClip.cs" company="BovineLabs">
...
namespace BovineLabs.Vibe.Authoring.Volume
{
    ...
    /// <summary>
    /// Clip that restores color adjustments to their captured initial values.
    /// </summary>
    [Serializable]
    public class VolumeColorAdjustmentsInitialClip : DOTSClip, ITimelineClipAsset
    {
        /// <inheritdoc/>
        ...
        public override void Bake(Entity clipEntity, BakingContext context)
        {
            ...
            blob.Type = VolumeColorAdjustmentsClipType.Initial;
