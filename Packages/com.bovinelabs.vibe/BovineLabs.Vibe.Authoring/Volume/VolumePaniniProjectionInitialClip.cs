// <copyright file="VolumePaniniProjectionInitialClip.cs" company="BovineLabs">
...
namespace BovineLabs.Vibe.Authoring.Volume
{
    ...
    /// <summary>
    /// Clip that restores panini projection settings to their captured initial values.
    /// </summary>
    [Serializable]
    public class VolumePaniniProjectionInitialClip : DOTSClip, ITimelineClipAsset
    {
        /// <inheritdoc/>
        ...
        public override void Bake(Entity clipEntity, BakingContext context)
        {
            ...
            blob.Type = VolumePaniniProjectionClipType.Initial;
