// <copyright file="VolumeChromaticAberrationInitialClip.cs" company="BovineLabs">
...
namespace BovineLabs.Vibe.Authoring.Volume
{
    ...
    /// <summary>
    /// Clip that restores chromatic aberration settings to their captured initial values.
    /// </summary>
    [Serializable]
    public class VolumeChromaticAberrationInitialClip : DOTSClip, ITimelineClipAsset
    {
        /// <inheritdoc/>
        ...
        public override void Bake(Entity clipEntity, BakingContext context)
        {
            ...
            blob.Type = VolumeChromaticAberrationClipType.Initial;
