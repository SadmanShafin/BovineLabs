...
public class SandpileTests
{
    ...
    {
        Assert.IsTrue(SandpileApi.TryCreate(3, 3, Allocator.Temp, out var s));
        SandpileApi.AddGrains(ref s, 4, 3); Assert.AreEqual(3, s.Grains[4]);
        SandpileApi.Dispose(ref s);
    }
    ...
    {
        Assert.IsTrue(SandpileApi.TryCreate(3, 3, Allocator.Temp, out var s));
        SandpileApi.AddGrains(ref s, 4, 3); Assert.AreEqual(0, s.Queue.Count);
        SandpileApi.Dispose(ref s);
    }
    ...
    {
        Assert.IsTrue(SandpileApi.TryCreate(3, 3, Allocator.Temp, out var s));
        SandpileApi.AddGrains(ref s, 4, 4); Assert.IsTrue(s.Queue.Count > 0);
        SandpileApi.Dispose(ref s);
    }
    ...
    {
        Assert.IsTrue(SandpileApi.TryCreate(3, 3, Allocator.Temp, out var s));
        SandpileApi.AddGrains(ref s, 4, 3); SandpileApi.RelaxAll(ref s); Assert.AreEqual(3, s.Grains[4]);
        SandpileApi.Dispose(ref s);
    }
