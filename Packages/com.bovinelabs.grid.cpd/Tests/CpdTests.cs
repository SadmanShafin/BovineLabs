...
public class CpdTests
{
    ...
    { Assert.IsTrue(CpdApi.TryCreate(5, 5, 1000, Allocator.Temp, out var s)); Assert.AreEqual(25, s.Grid.Length); CpdApi.Dispose(ref s); }
    ...
    [Test] public void Dispose_Double() { Assert.IsTrue(CpdApi.TryCreate(3, 3, 10, Allocator.Temp, out var s)); CpdApi.Dispose(ref s); CpdApi.Dispose(ref s); }
}
