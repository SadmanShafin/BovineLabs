...
namespace BovineLabs.Grid.Wavestar.Tests
{
    ...
    public class WavestarTests
    {
        ...
        {
            Assert.IsTrue(WavestarBuilder.TryBuild(grid, sizeX, sizeY, sizeZ, 3, out var traversable, out var distField));
        ...
        public void Wavestar_MultiResolution_RefinesNearObstacles()
        {
            ...
            Assert.IsTrue(WavestarBuilder.TryBuild(grid, GridSize, GridSizeY, GridSize, 3, out var traversable, out var distField));
