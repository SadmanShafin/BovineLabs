...
public class GraphCutTests
{
    ...
    [Test] public void Bottleneck_FlowIsMinCut()
    {
        ...
        GraphCutApi.Dispose(ref s); u0.Dispose(); u1.Dispose(); pw.Dispose(); labels.Dispose();
    }

    [Test] public void GridPartition_SymmetricCut()
    {
    ...
    { Assert.IsTrue(GraphCutApi.TryCreate(3, 3, 20, Allocator.Temp, out var s)); GraphCutApi.Dispose(ref s); GraphCutApi.Dispose(ref s); }
}
